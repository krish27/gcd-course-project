...
## Script run_analysis.R to clean data and prepare clean tidy dataset

## Follow Readme.md file for futher instructions and details about script.

## This script uses functions from reshape2 packages, so install and load these packages first
